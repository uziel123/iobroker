...
<head><title>ioBroker.web</title>
    ...
    <script>
        ...
        $(document).ready(function () {
            translateAll();
            if (document.location.href.indexOf('iobroker.net') === -1 &&
                document.location.href.indexOf('iobroker.pro') === -1) {
                $('.account-button').hide();
