<!DOCTYPE html><html manifest="app.manifest"><head>
    <meta charset="utf-8">
...
</script><dom-module id="iron-pages" assetpath="bower_components/iron-pages/">
...
</style><dom-module id="paper-item-shared-styles" assetpath="bower_components/paper-item/">
  <template>
    <style>
      :host, .paper-item {
        display: block;
...
</script><dom-module id="paper-button" assetpath="bower_components/paper-button/">
  <template strip-whitespace="">
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
--><script src="bower_components/promise-polyfill/Promise.js"></script><script>
if (!window.Promise) {
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
--><script src="bower_components/promise-polyfill/Promise-Statics.js"></script><script src="https://www.gstatic.com/charts/loader.js"></script>
<script>
(function() {
  "use strict";
...
</script><dom-module id="google-chart-styles" assetpath="bower_components/google-chart/">
  <template>
    <style>
      :host {
        display: -webkit-flex;
...
<dom-module id="node-red-polymer" assetpath="elements/">
...
</dom-module><dom-module id="node-red-paper-dropdown" assetpath="elements/">
    <template>
        <style>
            :host {
                display: inline-block;
...
<dom-module id="node-red-paper-button" assetpath="elements/">
    <template>
        <style>
            :host {
                display: inline-block;
...
</dom-module><dom-module id="node-red-paper-input" assetpath="elements/">
    <template>
        <style>
            :host {
                display: inline-block;
        ...
        <div id="input-container">
            <paper-input value="{{value}}" label="[[label]]" type="[[type]]" min="[[min]]" max="[[max]]" step="[[step]]" maxlength="[[maxlength]]" pattern="[[pattern]]" disabled="[[disabled]]"></paper-input>
...
</dom-module><dom-module id="node-red-html" assetpath="elements/">
    <template>
        <style>
            :host {
                display: inline-block;
    ...
    <script>
        Polymer({
            ...
            _html: function () {
                this.querySelector('#html-container').innerHTML = this.innerHTML;
            }
        })
    </script>

</dom-module><dom-module id="node-red-external" assetpath="elements/">
    <template>
        <style>
            :host {
                display: inline-block;
...
<dom-module id="node-red-collapse" assetpath="elements/">
    <template>
        <style>
            .header {
                @apply(--layout-horizontal);
...
</dom-module><dom-module id="node-red-chart-gauge" assetpath="elements/">
    <template>
        <style>
            :host {
                display: inline-block;
...
</dom-module><dom-module id="node-red-radial-gauge" assetpath="elements/">
    <template>
        <style>
            :host {
                display: inline-block;
        ...
        Polymer({
            ...
            attached: function () {
                this.gauge = new RadialGauge({
                    renderTo: this.querySelector('#gauge'),
                    width: 300,
                    height: 300,
                    value: 0
                }).draw();
            ...
            _value: function () {
                this.gauge && (this.gauge.value = this.value);
            }
        })
    </script>

</dom-module><dom-module id="node-red-linear-gauge" assetpath="elements/">
    <template>
        <style>
            :host {
                display: inline-block;
