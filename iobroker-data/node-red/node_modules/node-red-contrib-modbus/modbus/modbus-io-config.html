...
</span></label> <input type='text' id='node-config-input-addressOffset' placeholder='0'> </div> 
</script> <script type='text/x-red' data-help-name='modbus-io-config'>
